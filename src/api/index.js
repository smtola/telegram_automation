...
const APPSHEET_API_URL = "https://api.appsheet.com/api/v2/apps/0a8af6f9-8b8a-4fc8-a4f4-d125d4852bfd/tables/Invoice/Action";
...
async function fetchAppSheetData() {
  try {
    const response = await axios.post(
      APPSHEET_API_URL,
      {
        Action: "Find", // or GetAll, depending on what you want
        Properties: {},
        Rows: [],
      },
      {
